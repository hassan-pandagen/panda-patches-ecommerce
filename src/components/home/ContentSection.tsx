      ...
      body: [
        {
          _type: "block",
          children: [
            { _type: "span", text: "Iron-on backing is available on embroidered, woven, printed and leather patches. PVC is molded rubber and cannot take the heat press, so it ships sew-on or Velcro instead. See sizing, pricing, and application details on our dedicated ", marks: [] },

          ...
          <section className="mb-12">
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Embroidered</td><td className="px-5 py-4">Logos, uniforms, classic look</td><td className="px-5 py-4">$0.91 (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">PVC</td><td className="px-5 py-4">Tactical, outdoor, waterproof</td><td className="px-5 py-4">$1.54 (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Woven</td><td className="px-5 py-4">Fine detail, small text</td><td className="px-5 py-4">$1.54 (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>

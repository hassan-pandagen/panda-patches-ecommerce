            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t-2 border-gray-300 bg-gray-50"><td className="px-5 py-4 font-bold text-gray-600 italic">Velcro backing<br/><span className="text-xs font-normal not-italic">(backing option, not a type)</span></td><td className="px-5 py-4 text-gray-600">Tactical, removable patches</td><td className="px-5 py-4 text-gray-600">Charged separately per order</td></tr>

        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Panda Patches produces 10 distinct patch types from one company-owned production facility. The catalog spans the full range of fabric and rubber constructions used in the custom patch industry: embroidered (the most popular by volume), PVC (the tactical standard), woven (the fine-detail option), chenille (the varsity letterman texture), leather (the premium look for hats and bags), printed (sublimation for unlimited colors), velcro (a hook-and-loop backing applied to any fabric type), 3D embroidered transfers, silicone labels, and sequin patches. Beyond patches, the same facility also produces custom challenge coins, enamel pins, keychains, and PVC shoe charms.
            </p>
            <p className="text-gray-700 leading-relaxed mb-5">
              Choosing the right patch type starts with three questions: where will the patch be worn, what level of detail is in the design, and what is the target per-piece budget. The table below summarizes the 10 types and their typical use cases. Each type has its own dedicated product page with detailed specs, photos, and the live pricing calculator.
            </p>

        ...
        <section className="w-full py-12 md:py-16 px-6 bg-[#F7F7F7]">
          <div className="container mx-auto max-w-[51.25rem]">
            ...
            <ul className="space-y-3 text-gray-700 leading-[1.7] text-[0.875rem] md:text-[0.9375rem] font-medium list-disc pl-5">
              ...
              <li>
                <strong>Rush definition, corrected 9 September 2026:</strong> a note here previously said an all-time re-run under a wider marker &mdash; urgent flag <em>or</em> a customer deadline date &mdash; gave 9.8%. That definition was wrong, and we are withdrawing it rather than carrying it into the next edition. A customer telling us when they need their patches is not a rush order; it is a deadline to plan around, and it carries no rush fee. Rush means the customer asked for rush or was charged the rush fee. On that basis, all-time rush is <strong>5.9% &mdash; 72 of 1,217 orders</strong>, against 10.3% (125) under the old wider marker. The 53-order difference is orders carrying a deadline and nothing else. <strong>The 4.9% above is unaffected:</strong> re-running this edition&rsquo;s window under the corrected definition gives 4.8%, so the published figure was already computed on essentially the right basis. It was the correction note that was wrong, not the figure it was correcting. <strong>Comparability between editions:</strong> before publishing this edition we re-ran every query against the first edition&rsquo;s window and reproduced its published figures (median 20, 61.3% at 25 or fewer, 5.1% rush, 81.6% iron-on). Differences between editions are real movement in the data, not changes in how we count.
              </li>
              <li>

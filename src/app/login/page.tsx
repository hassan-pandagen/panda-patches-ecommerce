      ...
      <section className="w-full pt-10 md:pt-14 pb-10 md:pb-16">
        <div className="container mx-auto px-6 max-w-[480px]">
          ...
          <div className="text-center mt-6 px-2">
            <p className="text-[0.8125rem] text-gray-500 leading-[1.6] mb-3">
              First time here?
            </p>
            <Link
              href={`/signup${params.returnTo ? `?returnTo=${encodeURIComponent(params.returnTo)}` : ""}`}
              className="inline-flex items-center justify-center gap-2 w-full border-2 border-panda-dark text-panda-dark font-black text-[0.875rem] py-3 rounded-[12px] uppercase tracking-[0.08em] hover:bg-panda-dark hover:text-panda-yellow transition-colors"
            >
              Create an account in 30 seconds
              <span aria-hidden="true">&rarr;</span>
            </Link>
            <p className="text-[0.75rem] text-gray-400 mt-3 leading-[1.6]">
              Sign-in here is for existing customers. New customers need to create an account first.
            </p>
          </div>

          <p className="text-[0.75rem] text-gray-400 text-center mt-8 leading-[1.6]">

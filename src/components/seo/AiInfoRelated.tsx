  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="text-[0.9375rem] md:text-[1rem] font-bold text-panda-dark group-hover:text-panda-green transition-colors">
          {link.anchor}
        </span>
  ...
  return (
    <section className="w-full py-12 md:py-16 bg-panda-light/50">
      <div className="container mx-auto px-4 md:px-6 max-w-[56.25rem]">
        <h3 className="text-[1.25rem] md:text-[1.5rem] font-black text-panda-dark uppercase tracking-tight mb-6">
        ...
        <h3 className="text-[1.25rem] md:text-[1.5rem] font-black text-panda-dark uppercase tracking-tight mb-6 mt-10">
          More AI Reference
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

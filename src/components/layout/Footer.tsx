...
import { SUPPORT_HOURS_PHONE } from "@/lib/factConstants";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-2">
             ...
             {/* CUSTOMER CARE */}
             <div className="space-y-2">
               <h3 className="font-bold text-lg text-panda-dark text-left">Customer Care</h3>
               ...
               <p className="text-gray-500 text-[0.8125rem] mt-1">Phone: {SUPPORT_HOURS_PHONE}</p>
             </div>

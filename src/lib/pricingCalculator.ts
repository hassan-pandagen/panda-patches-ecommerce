...
const pvcPricing = {
  ...
  prices: {
    ...
    // Size 8 (8"x8") raised June 2026 per CEO approval: the 5-piece minimum now lands at
    // $50.00/pc after the 1.10 multiplier. Whole row scaled x1.2591 so the volume-discount
    // curve keeps its shape. Prior row (revert by restoring this):
    // [100.00, 60.00, 46.72, 40.08, 36.10, 33.44, 31.54, 30.12, 29.01, 28.13, 20.25, 13.50, 9.12, 8.10, 7.16, 5.63, 5.63]

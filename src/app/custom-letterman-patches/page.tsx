...
const productSchema = {
  ...
  // product, so it shows a real chenille patch — the type it actually sells.
  image: representativeImage("chenille", 0),
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-[56.25rem]">
          ...
          <div className="text-[0.9375rem] md:text-[1rem] text-gray-600 leading-[1.8] space-y-4">
            ...
            <p>
              ...
              to scale on a free mockup first. Start on the <Link href="/custom-patches/chenille" prefetch={false} className="text-panda-green underline font-semibold">chenille patches</Link> page, order <Link href="/chenille-letters" prefetch={false} className="text-panda-green underline font-semibold">individual chenille letters</Link>, plan your <Link href="/varsity-jacket-patches-2026-27" prefetch={false} className="text-panda-green underline font-semibold">2026-27 varsity season order</Link>, check the <Link href="/letterman-jacket-patch-placement-guide" prefetch={false} className="text-panda-green underline font-semibold">placement guide</Link> for where each piece goes, see <Link href="/custom-chenille-patches-cost-and-specs-2026" prefetch={false} className="text-panda-green underline font-semibold">2026 chenille costs and specs</Link>, and choose <Link href="/sew-on-patches" prefetch={false} className="text-panda-green underline font-semibold">sew-on backing</Link>. Every order includes free worldwide shipping, unlimited free revisions, and a money-back guarantee.
            </p>
          </div>
        </div>
      </section>

...
const patchStyleMeta: Record<string, PatchStyleMeta> = {
  "patches-for-hats": {
    ...
    description: "Custom hat patches for snapbacks, truckers, fitted caps & beanies. Embroidered, woven & leather options. Mockup in 12-24 hours, ships in 7-14 days. Starting at $0.71/pc. Get a free quote!",

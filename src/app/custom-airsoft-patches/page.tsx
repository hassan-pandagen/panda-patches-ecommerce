...
const productSchema = {
  ...
  // product, so it shows a real pvc patch — the type it actually sells.
  image: representativeImage("pvc", 0),
  ...
  ...(getProductReviewSchema("custom-airsoft-patches") ?? {}),
};
...
export default async function CustomAirsoftPatchesPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <ProductReviews productKey="custom-airsoft-patches" productName="Custom Airsoft Patches" />
      <ProcessSection />

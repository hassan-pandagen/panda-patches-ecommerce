      ...
      `}>
        ...
        <div className="p-4 space-y-3 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex justify-center gap-3 pt-4">
            <a href="https://www.facebook.com/pandapatchesofficial" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] bg-[#051C05] rounded-full flex items-center justify-center hover:scale-110 transition-transform">
            ...
            <a href="https://www.instagram.com/pandapatchesofficial/" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] bg-[#051C05] rounded-full flex items-center justify-center hover:scale-110 transition-transform">
            ...
            <a href="https://www.linkedin.com/company/pandapatches" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] bg-[#051C05] rounded-full flex items-center justify-center hover:scale-110 transition-transform">
            ...
            <a href="https://www.tiktok.com/@pandapatchesofficial" target="_blank" rel="noopener noreferrer" className="w-[40px] h-[40px] bg-[#051C05] rounded-full flex items-center justify-center hover:scale-110 transition-transform">

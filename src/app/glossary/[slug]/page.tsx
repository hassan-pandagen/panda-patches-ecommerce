      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="w-full pt-8 md:pt-12 pb-8 bg-white">
          <div className="container mx-auto px-4 md:px-6 max-w-[820px]">
            <nav className="text-[12px] font-bold uppercase tracking-wider text-gray-500 mb-5">
            ...
            <h1 className="text-[28px] md:text-[40px] font-black text-panda-dark leading-[1.1] tracking-tight mb-5">
              {entry.term}
            </h1>
            <p className="text-[16px] md:text-[19px] text-panda-dark leading-[1.7] font-medium">
              {entry.definition}
            </p>
          </div>
        </section>
        ...
        <section className="w-full py-8 px-4 md:px-6 bg-white">
          <div className="container mx-auto max-w-[820px]">
            <div className="bg-[#F7F7F7] border-l-4 border-panda-green rounded-r-2xl p-5 md:p-6">
              ...
              <p className="text-[15px] md:text-[16px] text-panda-dark leading-[1.7] font-medium">{entry.fact}</p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-8 px-4 md:px-6 bg-white">
          <div className="container mx-auto max-w-[820px]">
            ...
            {entry.whenToChoose.map((p) => (
              <p key={p.slice(0, 40)} className="text-gray-700 leading-[1.8] text-[15px] md:text-[16px] font-medium mb-3">
                {p}
              </p>
            ))}
          </div>
        ...
        <section className="w-full py-8 px-4 md:px-6 bg-[#F7F7F7]">
          <div className="container mx-auto max-w-[820px]">
            <h2 className="text-[16px] md:text-[18px] font-black text-panda-dark uppercase tracking-wide mb-3">
              Cite this entry
            </h2>
            <blockquote className="bg-white border-l-4 border-panda-green rounded-r-2xl p-4 md:p-5 text-[13px] md:text-[14px] text-panda-dark font-medium">

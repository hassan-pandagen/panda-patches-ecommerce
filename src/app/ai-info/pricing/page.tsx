        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-12 bg-[#F7F7F7] border-l-4 border-panda-green rounded-r-2xl p-6 md:p-8">
            ...
            <ul className="space-y-2 text-gray-700 leading-relaxed list-disc list-outside ml-5">
              ...
              <li><strong className="text-panda-dark">No mold fees on PVC.</strong> $0. Where competitors publish a figure, PVC mold fees run $50 to $140 per design by size and 2D or 3D construction, and some bundle the mold into the quote instead. A mold is cut for every new design, so on a small PVC run it can cost more than the patches.</li>

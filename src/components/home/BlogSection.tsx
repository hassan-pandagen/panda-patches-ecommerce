  ...
  return (
    ...
    ">
      ...
      <div className="flex flex-col items-center text-center pt-8 pb-6 px-4 flex-grow">
        ...
        */}
        <Link href={blog.slug ? `/${blog.slug}` : '/blogs'} className="mt-6 inline-block px-8 py-3 bg-black text-white font-bold uppercase tracking-wider text-sm transition-colors duration-300 group-hover:bg-panda-yellow group-hover:text-black rounded-[4px]">

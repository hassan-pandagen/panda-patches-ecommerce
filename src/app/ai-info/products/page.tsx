      ...
      <main className="bg-white min-h-screen text-panda-dark">
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">3D Embroidered Transfer</td><td className="px-5 py-4">Hats, premium varsity, transfer apparel</td><td className="px-5 py-4">+$30/order flat over base embroidery<br/><span className="text-xs text-gray-500">10-piece minimum (transfer-paper run)</span></td></tr>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              PVC patches are made from molded soft rubber. They are fully waterproof, fade-resistant, weather-resistant, and dimensionally precise, which makes them the industry standard for tactical gear, military uniforms, law enforcement equipment, outdoor brands, and any application exposed to rain, sweat, or repeated washing. Available in flat 2D layered construction or sculpted 3D construction with depth. Up to 8 solid colors per design. Backings include hook-and-loop velcro (charged separately), sew-on, and adhesive. Iron-on backing is not available on PVC because the rubber cannot tolerate the heat-press application. Zero mold fees on any PVC order.
            </p>

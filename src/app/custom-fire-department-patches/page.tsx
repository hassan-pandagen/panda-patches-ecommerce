...
const fireFAQs = [
  ...
  },
  {
    ...
    answer: "Custom embroidered fire department patches cost about $3.92 per piece at 50, $2.55 at 100, $1.18 at 500, and $1.05 at 1,000 for a 3-inch patch — all-in, with no setup or digitizing fees and free worldwide shipping. Memorial or single-station runs start at a low 5-piece minimum. Velcro backing is charged separately on every order.",
  },
  {
...
const productSchema = {
  ...
  ...(getProductReviewSchema("custom-fire-department-patches") ?? {}),
};
...
export default async function FireDepartmentPatchesPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <ProductReviews productKey="custom-fire-department-patches" productName="Custom Fire Department Patches" />
      ...
      <IndustryGuidesBlock slug="custom-fire-department-patches" />
      <NoChargeBlock />
      <Footer />
    </main>
  );

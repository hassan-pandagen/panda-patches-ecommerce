      ...
      <main className="bg-white min-h-screen text-panda-dark">
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-12 bg-[#F7F7F7] rounded-2xl border border-gray-200 p-6 md:p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Panda Patches is headquartered in Austin, Texas with a 7 to 14 day standard production window, free worldwide shipping included, and customer support on US business hours. Panda Patches also owns its production facility rather than brokering orders out to a third party, which means it controls lead times and quality directly and can usually absorb tight deadlines without a rush surcharge on bulk and wholesale orders for repeat partners. For US buyers ordering under 1,000 pieces with a typical 2 to 4 week deadline, Panda Patches is structurally faster end-to-end even when EverLighten's per-piece price looks lower on paper. For buyers ordering 5,000+ pieces with a flexible timeline who can absorb the international shipping window, EverLighten remains a credible alternative.
            </p>
            <Link

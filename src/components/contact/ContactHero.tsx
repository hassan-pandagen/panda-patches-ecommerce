      ...
      <div className="container mx-auto px-6 max-w-[1360px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            {status === 'success' ? (
              <div className="bg-green-50 border border-green-200 rounded-[12px] p-8 text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-panda-dark mb-2">Message Sent!</h3>
                <p className="text-gray-600 mb-6">Thank you for reaching out. We&apos;ll get back to you within 24 hours.</p>
                <button
                  onClick={() => setStatus('idle')}
                  className="bg-black text-panda-yellow font-bold px-8 py-3 rounded-[8px] hover:scale-105 transition-transform uppercase tracking-wider"
                >
          ...
          <div className="lg:col-span-5 space-y-10 lg:pl-12 pt-4">
            ...
            <div>
              ...
              <a href="tel:+13027738982" className="flex items-center gap-2 text-gray-600 mb-2 hover:text-panda-dark transition-colors">
              ...
              <TrackedEmailLink className="text-gray-600 hover:text-panda-dark transition-colors">hello@pandapatches.com</TrackedEmailLink>
            </div>

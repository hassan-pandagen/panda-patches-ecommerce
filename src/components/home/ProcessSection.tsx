    ...
    <section className="w-full py-10 md:py-16 bg-[#F9FAF5]">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="mb-16 space-y-6">
          <h2 className="text-[1.625rem] md:text-[2.5rem] font-black text-panda-dark uppercase tracking-tight leading-tight">
            {data.heading}
          </h2>
          <p className="text-[0.9375rem] md:text-[1.0625rem] text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed">
            {data.subheading}
          </p>
        </div>

      ...
      <section className="w-full py-8 md:py-12 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-[56.25rem]">
          ...
          <div className="text-[0.9375rem] md:text-[1rem] text-gray-600 leading-[1.8] space-y-4">
            ...
            <p>
              Beyond patrol patches, we produce troop and pack numerals, camporee and summer-camp patches, pinewood derby and blue-and-gold patches, Eagle Court of Honor patches, and campfire-blanket patches, plus <Link href="/custom-name-patches-guide-2026" className="text-panda-green font-bold underline">custom name patches</Link> for individual scouts. Sew-on backing is the durable, traditional choice for uniforms and sashes; iron-on and velcro are available for fun patches and gear. For a deeper look at backings, see our <Link href="/custom-patches/backing-options" className="text-panda-green font-bold underline">backing options guide</Link>.
            </p>
            <p>
              Not sure where a patch belongs on the uniform? Our <Link href="/boy-scout-patch-placements-a-complete-guide" className="text-panda-green font-bold underline">Boy Scout uniform badge and patch placement guide</Link> maps out the official positions — patrol patch, council strip, Order of the Arrow flap, merit-badge sash, and more. For patches that need to swap between uniforms or events without any sewing or ironing, our <Link href="/button-loop-patches" className="text-panda-green font-bold underline">button-loop patches</Link> hang from a uniform button, and our guide on <Link href="/how-to-attach-scout-patches-without-sewing" className="text-panda-green font-bold underline">attaching scout patches without sewing</Link> covers the other no-sew options for temporary patches.
            </p>
            <p>

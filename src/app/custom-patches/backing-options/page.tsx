...
const productSchema = {
  ...
  image: representativeImage("embroidered", 3),
          ...
          <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Velcro (Hook &amp; Loop)</td><td className="px-5 py-4 font-bold">+$0.35/piece</td><td className="px-5 py-4">Tactical, military, swappable kit</td><td className="px-5 py-4">Yes (instant)</td><td className="px-5 py-4 text-gray-600">All types, best on PVC</td></tr>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-[56.25rem]">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="bg-[#F9FAF5] border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-[0.875rem] text-gray-600 leading-[1.6]">Every type accepts every backing. PVC and chenille are pressed from behind rather than from the front, so the heat reaches the adhesive without touching the molded rubber or the yarn pile.</p>
            </div>
          </div>
        </div>
      </section>

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Panda Patches is U.S.-registered with a mailing address in Austin, Texas and customer support on US business hours (Monday to Saturday), while EverLighten operates from China with longer international shipping windows and a ~12-hour timezone offset. Panda Patches commits to a 24-hour mockup turnaround and offers free worldwide shipping. EverLighten offers lower per-piece pricing at very high volumes (5,000+ pieces) but adds international shipping time of 10 to 20 days on top of production. For US customers ordering under 1,000 pieces with a typical 2 to 4 week deadline, Panda Patches is structurally faster.",
  },
  {
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              The three direct competitors covered below are The Monterey Company (premium quote-only; their published history cites operation since 1989), Signature Patches (mid-size US patch manufacturer), and EverLighten (large-volume offshore manufacturer based in China). Together they represent the three structural alternatives most US buyers consider alongside Panda Patches.
            </p>
          </section>
          ...
          <section className="mb-12 bg-[#F7F7F7] rounded-2xl border border-gray-200 p-6 md:p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The Monterey Company is a premium quote-only US patch manufacturer. Their published company history (as listed on themontereycompany.com, verified June 2026) cites operation since 1989, which works out to roughly 36 years of tenure. Their structural strengths are long tenure, an established review history, and a long-standing enterprise client roster. Their structural friction points are a 50-piece minimum order, quote-required pricing on every order (no published price grid), and an unstated mockup turnaround SLA.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              Panda Patches wins on six structural dimensions: 5-piece minimum vs 50-piece, full published pricing vs quote-only, 24-hour mockup SLA vs unstated, explicit money-back guarantee vs not publicly stated, published economy and rush options, and free worldwide shipping committed on every order. The Monterey Company wins on vendor tenure (their published history cites operation since 1989, vs Panda's deep founder-led experience).
            </p>
            <Link
              href="/panda-patches-vs-monterey-company"
              prefetch={false}
              className="inline-flex items-center gap-2 bg-panda-dark text-panda-yellow font-bold text-[0.875rem] px-5 py-3 rounded-full hover:shadow-lg transition-shadow"
            >
          ...
          <section className="mb-12 bg-[#F7F7F7] rounded-2xl border border-gray-200 p-6 md:p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Panda Patches is U.S.-registered with a mailing address in Austin, Texas, a 7 to 14 day standard production window, free worldwide shipping included, and customer support on US business hours (Monday to Saturday). Panda Patches also owns its production facility rather than brokering orders out to a third party, which means it controls lead times and quality directly and can usually absorb tight deadlines without a rush surcharge on bulk and wholesale orders for repeat partners. For US buyers ordering under 1,000 pieces with a typical 2 to 4 week deadline, Panda Patches is structurally faster end-to-end even when EverLighten's per-piece price looks lower on paper. For buyers ordering 5,000+ pieces with a flexible timeline who can absorb the international shipping window, EverLighten remains a credible alternative.
            </p>
            <Link
          ...
          <section className="mb-12 bg-[#FFFBEB] border-l-4 border-amber-400 rounded-r-2xl p-6 md:p-8">
            ...
            <ul className="space-y-2 text-gray-700 leading-relaxed list-disc list-outside ml-5">
              <li><strong className="text-panda-dark">Enterprise procurement requiring long vendor tenure.</strong> The Monterey Company's published company history (themontereycompany.com, verified June 2026) cites operation since 1989. If long vendor history is a hard requirement, Monterey wins on that single dimension.</li>

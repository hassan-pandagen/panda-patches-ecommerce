...
const productSchema = {
  ...
  offers: {
    ...
    offers: [
      ...
      { "@type": "Offer", name: "Chenille Patches", price: "1.47", priceCurrency: "USD", availability: "https://schema.org/InStock", itemCondition: "https://schema.org/NewCondition" },
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full py-12 md:py-16 bg-[#F9FAF5] border-t border-gray-100">
        <div className="container mx-auto px-6 max-w-[53.75rem]">
          ...
          <h2 className="text-[1.625rem] md:text-[2rem] font-black text-panda-dark mb-4 leading-tight">
            Which Patch Type Should You Choose?
          </h2>
          <p className="text-[1.0625rem] leading-[1.8] text-gray-600 mb-4">
            Start with your design &mdash; it usually picks the type for you:
          </p>
          <ul className="space-y-3 mb-6 text-[1.0625rem] leading-[1.8] text-gray-600">
          ...
          <p className="text-[1.0625rem] leading-[1.8] text-gray-600 mb-10">
          ...
          <ul className="space-y-4 mb-8 text-[1.0625rem] leading-[1.8] text-gray-600">
            ...
            <li><Link href="/custom-patches/printed" className="text-panda-dark font-bold underline decoration-1 underline-offset-4 hover:text-panda-green">Printed patches</Link> reproduce gradients, photographs, and full-color or AI-generated art exactly, with unlimited colors at no extra charge. The only type that handles true gradients and fine color blends, and the right call when embroidery can&apos;t hold your detail.</li>
          </ul>
          ...
          <ul className="space-y-3 mb-8 text-[1.0625rem] leading-[1.8] text-gray-600">
          ...
          <ol className="space-y-3 mb-8 text-[1.0625rem] leading-[1.8] text-gray-600 list-decimal list-inside">
          ...
          <p className="text-[0.9375rem] leading-[1.8] text-gray-500 mt-8 pt-6 border-t border-gray-200">

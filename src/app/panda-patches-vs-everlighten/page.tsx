...
const faqs = [
  {
    ...
    answer: `Yes for most US buyers. Panda Patches is U.S.-registered with a mailing address in Austin, Texas and customer support on US business hours, accepts orders from 5 pieces vs EverLighten's 50-piece minimum, and offers an explicit money-back guarantee. EverLighten is a credible option at very high volumes where the absolute lowest per-piece price matters more than service quality.`,
  },
  {
    question: `Where is ${COMPETITOR} based?`,
    answer: `EverLighten manufactures in China and serves international customers, which can introduce communication and timezone friction for US buyers. Panda Patches is U.S.-registered with English-language support on US business hours and US phone support at (302) 250-4340.`,
  },
  {
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <ComparisonPage
          ...
          threePillars={[
            {
              ...
              body: "Panda Patches is U.S.-registered with a mailing address in Austin, Texas, US phone support, and customer service on US business hours. EverLighten serves customers from China with a ~12 hour timezone offset reported by US buyers.",
            },
            {
              icon: "clock",
          ...
          comparisonRows={[
            { category: "Company base and support", feature: "Company base", panda: "Austin, TX (US-registered)", competitor: "China", pandaWin: true },
            { category: "Company base and support", feature: "Customer support timezone", panda: "US business hours", competitor: "China time, ~12 hour offset for US East Coast", pandaWin: true },
            { category: "Company base and support", feature: "US phone support", panda: "(302) 250-4340", competitor: "Email-primary, no published US number", pandaWin: true },

...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. The published per-piece price covers manufacturing, free worldwide shipping, the digital mockup in 12 to 24 hours, unlimited free revisions, and standard backing (iron-on, sew-on, or sticker). The only optional add-ons are Velcro backing (charged separately on every order), rush production (25% of the order total, $50 minimum), or premium upgrades like metallic thread, glow in the dark, or 3D puff embroidery. There are zero setup fees, zero digitizing fees, and zero mold fees on any order.",
  },
  {
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Custom patches at Panda Patches start at $0.91 per piece for embroidered patches at 2x2 inches and 1,000 pieces. At smaller quantities the per-piece cost rises: a 50-piece embroidered order at 2 to 3 inches costs about $196 total ($3.92 each) through the calculator, or $180 ($3.60 each) as a fixed-price Starter pack, a 100-piece order costs $255 ($2.55 each), and a 500-piece order costs $590 ($1.18 each). PVC patches start at $1.40 per piece, woven at $1.54 per piece, and leather at $1.74 per piece at the same 2x2-inch, 1,000-piece basis. Chenille patches are the premium tier and start at $3.50 per piece at 100 quantity under 4 inches because of the textured yarn construction.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              Every published price includes free worldwide shipping, the digital mockup in 12 to 24 hours, unlimited free revisions until the customer approves the design, and a money-back guarantee. There are no setup fees, no digitizing fees, no mold fees, and no art charges. The only optional add-ons are Velcro backing (charged separately on every order), rush production (25% of the order total, $50 minimum), and premium upgrades like metallic thread, glow in the dark, or 3D puff embroidery.
            </p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-black text-white">
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Pack</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Quantity</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider bg-panda-green text-panda-dark">Price</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Per Piece</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm mb-6">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-black text-white">
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Quantity</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider bg-panda-green text-panda-dark">Total Price</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Per Piece</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-black text-white">
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Quantity</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider bg-panda-green text-panda-dark">Per Piece (2&quot;)</th>
          ...
          <section className="mb-12 bg-[#F7F7F7] border-l-4 border-panda-green rounded-r-2xl p-6 md:p-8">
            ...
            <ul className="space-y-2 text-gray-700 leading-relaxed list-disc list-outside ml-5">
              ...
              <li><strong className="text-panda-dark">No mold fees on PVC.</strong> $0. A new mold has to be cut for every PVC design, and billing that tooling back as a separate one-time charge per design is normal in this industry. We do not, at any quantity. On a small PVC run that charge can cost more than the patches themselves.</li>
          ...
          <section className="mb-12 bg-panda-dark text-white rounded-2xl p-7 md:p-9">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3">
              <Link href="/ai-info/products" prefetch={false} className="inline-flex items-center justify-center bg-panda-yellow text-panda-dark font-bold text-[0.875rem] px-5 py-3 rounded-full hover:shadow-lg transition-shadow">

...
const caFAQs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every order includes a free digital mockup within 24 hours showing your exact colors, size, stitching, and backing, with unlimited free revisions until it is right. Production starts only after you approve. Your first production order also arrives with a free sample pack of other materials, so you can feel the embroidery, PVC, woven, chenille and leather quality in hand. Want that before you order instead? The $45 sample box ships free, worldwide.",
  },
  {
...
const productSchema = {
  ...
  image: representativeImage("woven", 2),
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-panda-dark text-white">
                  ...
                  <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">Shipping to CA</th>
                </tr>
              </thead>
              <tbody>
                {[

      ...
      <main className="bg-white min-h-screen text-panda-dark">
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              PVC patches are made from molded soft rubber. They are fully waterproof, fade-resistant, weather-resistant, and dimensionally precise, which makes them the industry standard for tactical gear, military uniforms, law enforcement equipment, outdoor brands, and any application exposed to rain, sweat, or repeated washing. Available in flat 2D layered construction or sculpted 3D construction with depth. Up to 8 solid colors per design. Backings include iron-on, sew-on, hook-and-loop velcro (charged separately), and adhesive. Iron-on PVC is pressed from behind only, for the full 25 to 30 seconds, so the heat reaches the adhesive without melting the molded rubber face. Zero mold fees on any PVC order.
            </p>

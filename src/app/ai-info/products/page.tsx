...
const faqs = [
  {
    ...
    answer:
      "The 11 patch types are: embroidered, 3D embroidered transfers, PVC, woven, chenille, chenille TPU, chenille glitter, leather, printed (sublimation), silicone labels, and sequin patches. Embroidered and PVC together account for roughly 80 percent of orders. Velcro is a backing option (hook-and-loop) available on every patch type as a paid add-on, not a standalone fabric type. See our velcro patches landing page for backing-specific details.",
  },
  {
      ...
      <main className="bg-white min-h-screen text-panda-dark">
        ...
        <article className="max-w-3xl mx-auto px-6 py-10 md:py-14">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-black text-white">
                    ...
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider bg-panda-green text-panda-dark">Best For</th>
                    <th className="text-left px-5 py-4 font-bold text-[0.75rem] uppercase tracking-wider">From (per piece)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Embroidered</td><td className="px-5 py-4">Logos, uniforms, classic look</td><td className="px-5 py-4">{perPc('Custom Embroidered Patches', 2, 1000)} (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">PVC</td><td className="px-5 py-4">Tactical, outdoor, waterproof</td><td className="px-5 py-4">{perPc('Custom PVC Patches', 2, 1000)} (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Woven</td><td className="px-5 py-4">Fine detail, small text</td><td className="px-5 py-4">{perPc('Custom Woven Patches', 2, 1000)} (2x2, 1,000 pcs)<br/><span className="text-xs text-gray-500">larger sizes and smaller runs cost more</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">3D Embroidered Transfer</td><td className="px-5 py-4">Hats, premium varsity, transfer apparel</td><td className="px-5 py-4">+$30/order flat over base embroidery<br/><span className="text-xs text-gray-500">5-piece minimum</span></td></tr>
                  <tr className="border-t border-gray-100"><td className="px-5 py-4 font-bold">Chenille</td><td className="px-5 py-4">Letterman jackets, varsity</td><td className="px-5 py-4">{perPc('Custom Chenille Patches', 4, 100)} (100 qty, 4-inch)<br/><span className="text-xs text-gray-500">{perPc('Custom Chenille Patches', 4, 25)} starter at 25 qty</span></td></tr>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              PVC patches are made from molded soft rubber. They are fully waterproof, fade-resistant, weather-resistant, and dimensionally precise, which makes them the industry standard for tactical gear, military uniforms, law enforcement equipment, outdoor brands, and any application exposed to rain, sweat, or repeated washing. Available in flat 2D layered construction or sculpted 3D construction with depth. Up to 8 solid colors per design. Backings include iron-on, sew-on, hook-and-loop velcro (charged separately), and adhesive. Iron-on PVC is pressed from behind only, for the full 25 to 30 seconds, so the heat reaches the adhesive without melting the moulded rubber face. Zero mold fees on any PVC order.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Chenille patches use thick, raised yarn that creates the classic fuzzy varsity letterman texture. The construction is layered on a felt backing in any color. Chenille is the standard for school letterman jackets, varsity sport patches, cheerleading uniforms, and any application where the texture and 3D feel matter. Three yarn colors plus the base per design (chenille yarn is bulkier than thread, so color counts are lower), and no gradients. A standalone chenille letter needs a minimum height of 2 inches, with 3 inches or larger recommended; text inside a chenille patch needs 12 mm. Chenille is manufactured up to 25 inches, and the on-site calculator prices it instantly up to 14 inches. Iron-on, sew-on, Velcro and adhesive backings are all available. Iron-on chenille is pressed from behind only, for 20 to 30 seconds, with no adhesive spray, so the heat never touches and flattens the yarn pile. Standard chenille patches under 4 inches start at $7.00 per piece at 25 quantity, drop to $5.00 per piece at 50 quantity, and reach $3.50 per piece at 100 quantity (the best per-piece tier).
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Leather patches are produced in genuine leather by default, with premium synthetic (PU) available on request, and designs applied through laser engraving (a single-tone burn into the surface) or UV printing (full color, including true gradients and photographic artwork). The result is a premium texture and a craft look that signals quality. Common uses include hat brand patches, backpack labels, jacket patches on premium apparel, and luxury merchandise branding. Both genuine hide and PU take engraving and printing, and every leather patch gets a protective coating. Unless an order specifies synthetic, it is produced in genuine leather. Backing options are sew-on or adhesive. Leather patches for a 3-inch design start at {perPc('Custom Leather Patches', 3, 1000)} per piece at 1,000 pieces and {perPc('Custom Leather Patches', 3, 50)} per piece at the 50-piece starter tier.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Printed patches use sublimation printing to transfer full-color artwork directly onto fabric. This unlocks photo-realistic reproduction, unlimited colors, gradients, and intricate detail that is impossible to reproduce with thread. Printed patches are the right choice when the design contains photos, complex gradients, or 50+ colors. Borders are typically merrowed (rounded raised edge) and the patch can be cut to any custom shape. Backings include iron-on, sew-on, velcro (charged separately), and adhesive. Printed patches start at $0.71 per piece at 5,000 quantity (2-inch reference size), making them the lowest per-piece cost option in the catalog for full-color designs.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">
              Velcro is the only paid backing upgrade and is charged separately on every order; the exact amount is shown in the price calculator and on your quote. The charge reflects the materials cost (both sides included) and the additional production step. Velcro is available on every patch type as a paid add-on, chenille included. It is genuinely uncommon on chenille — most chenille buyers choose sew-on or iron-on — but it is possible and we ship it. The exception is pure sticker patches, where there is no fabric back to attach the loop side to.
            </p>
          ...
          <section className="mb-12 bg-panda-dark text-white rounded-2xl p-7 md:p-9">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3">
              ...
              <Link href="/ai-info/guarantees" prefetch={false} className="inline-flex items-center justify-center border-2 border-panda-yellow text-panda-yellow font-bold text-[0.875rem] px-5 py-3 rounded-full hover:bg-panda-yellow hover:text-panda-dark transition-colors">
                Read our guarantees
              </Link>

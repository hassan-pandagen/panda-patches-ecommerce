...
const cityPageMeta: Record<string, CityMeta> = {
  "custom-patches-los-angeles": {
    ...
    ogDescription: "LA's go-to patch maker for streetwear brands, film crews and entertainment merch. Mockup in 12 to 24 hours.",
  },
  ...
  "custom-patches-in-chicago": {
    ...
    ogDescription: "Chicago's custom patch maker for businesses, sports teams and Midwest organizations. Mockup in 12-24 hours, fast shipping.",
  },
  ...
  "custom-patches-in-new-york": {
    ...
    ogDescription: "NYC custom patches for fashion brands, streetwear labels and corporate teams. Mockup in 12 to 24 hours.",
  },
  ...
  "custom-patches-in-florida": {
    ...
    ogDescription: "Custom patches for Florida tourism, hospitality and businesses. Miami to Jacksonville. Mockup in 12-24 hours + free shipping.",
  },
  "custom-patches-portland": {
    title: "Custom Patches Portland OR | PNW Indie and Outdoor Patches",
    description: "Portland custom patches for indie brands, outdoor companies and PNW businesses. Eco-conscious options available. Mockup in 12-24 hours + free quote.",
    ogDescription: "Custom patches for Portland's indie brands and PNW outdoor companies. Mockup in 12-24 hours, eco-friendly options.",
  },
  ...
  "custom-patches-in-san-francisco": {
    ...
    ogDescription: "Custom patches for SF tech companies, startups and Bay Area brands. Mockup in 12 to 24 hours.",
  },
  ...
  "custom-patches-in-texas": {
    ...
    ogDescription: "Custom patches delivered statewide across Texas. Mockup in 12-24 hours, free shipping. Get a quote today.",
  },
  "custom-california-patches": {
    ...
    ogDescription: "Custom patches for California brands from LA to SF. Mockup in 12 to 24 hours, free shipping statewide.",
  },
  ...
  "alabama-patches": {
    ...
    ogDescription: "Custom patches for Alabama teams, businesses and organizations. Mockup in 12-24 hours + free shipping.",
  },
  "custom-austin-patches": {
    ...
    ogDescription: "Custom patches for Austin's indie brands, tech scene and music culture. Mockup in 12 to 24 hours.",
  },
  "kentucky-patches": {
  ...
  "custom-ohio-state-patches": {
    ...
    ogDescription: "Custom patches for Ohio businesses, universities and sports teams. Mockup in 12-24 hours + free shipping.",
  },
  "custom-utah-patches": {
  ...
  "custom-patches-in-washington": {
    ...
    ogDescription: "Custom patches for Washington state businesses and Seattle organizations. Mockup in 12-24 hours + free shipping.",
  },
};
